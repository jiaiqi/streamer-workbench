...
THEMES = {
    ...
    "青提气泡": dict(prefix="歌单海报-青提气泡版",
                    bgs=("bg1.png", "bg2.png"), watermark=True,
                    style={1: _GRAPE, 2: _GRAPE}),
    "卡通音符": dict(prefix="歌单海报-卡通音符版",
                    bgs=("bg1.png", "bg2.png"), watermark=True,
