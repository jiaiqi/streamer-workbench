...
| 执行顺序 | [`路线图.md`](路线图.md) | R0–R7 当前状态、依赖、阶段门和退出条件（**v4 — 2026-08-01**，R4 Runtime v2 部分收口 2026-08-12） |
| **整体分析** | [`项目整体分析-0801.md`](项目整体分析-0801.md) | **v4 新增 — 4 维度（功能/交互/UI/细节）盘点，路线图 v4 基于此** |
| **R4 Runtime v2 设计稿** | [`R4-Runtime-v2-设计稿.md`](R4-Runtime-v2-设计稿.md) | **906 行 / 10 章节 / 5 spike 详设** — V2.1（核心抽象）+ V2.2（三段式契约统一）已收口；V2.3 Palette/Skin 接线 + V2.4 Parameters 注入 + V2.5 能力矩阵待推 |
