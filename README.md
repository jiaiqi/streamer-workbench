...
>
> **下一步**：M3 SQLite FTS5 全文检索（2000+ 首数据规模后再做）+ 学习看板 + 精力分级；M4 Tauri 2 桌面壳 + PWA 评估（1-2 天调研）；R5 工作台系统化收尾（R4 v2 抽象已在 3 个场景验证稳定，可继续收 R5 创作效率段）；R7 桌面正式发布门（PyInstaller/electron-builder 完整 CI + 安装包测试 + macOS arm64）。
>
