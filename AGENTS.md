...
产品主线  R0 🟡      R0.1-R0.7 ✅；R0.8 API 基础完成，正式 React 视觉迁移进行中
桌面壳    spike 已过  正式壳 ⬜
...
| 测试 | 180 项 Python 测试 + 12 项前端测试 + 16 张金标准逐像素 + OpenAPI 类型漂移/tsc/build | 当前 CI 质量门；Windows 控制台 UTF-8 与依赖锁定仍待 R0 收口 |
